    ...
    with next(get_session()) as db_session:
        ...
        transactions_data = [
            ...
            },
            {
                ...
                "description": "Executar processamento de dados com IA",
                "audit_user_ip": "0.0.0.0",
                "audit_user_login": "system",
            },
            {
                "operation_code": EnumOperationCode.OP_3000001.value,
                "name": "Process Health Catalog",
                "description": "Processar catálogo de healthtechs com IA",
                "audit_user_ip": "0.0.0.0",
                "audit_user_login": "system",
            },
        ]
